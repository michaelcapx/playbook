...
###########################################################################
#
# Postfix Bootstrap Installer
# https://github.com/polymimetic/playbook/roles/postfix
#
...
#
# Usage:
# wget -qO - https://raw.githubusercontent.com/polymimetic/playbook/master/roles/postfix/install.sh | bash
#
###########################################################################
...
readonly GIT_RAW="https://raw.githubusercontent.com/polymimetic/playbook/master/roles/postfix"
...
install_postfix() {
  e_title "Installing Postfix"

  local postfix_files=${GIT_RAW}/files

  e_success "Postfix installed"
}
