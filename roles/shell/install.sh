...
###########################################################################
#
# Shell Bootstrap Installer
# https://github.com/polymimetic/playbook/roles/shell
#
...
#
# Usage:
# wget -qO - https://raw.githubusercontent.com/polymimetic/playbook/master/roles/shell/install.sh | bash
#
###########################################################################
...
readonly GIT_RAW="https://raw.githubusercontent.com/polymimetic/playbook/master/roles/shell"
...
install_shell() {
  e_title "Installing Shell"

  local shell_files=${GIT_RAW}/files

  e_success "Shell installed"
}
