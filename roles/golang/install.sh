...
###########################################################################
#
# Golang Bootstrap Installer
# https://github.com/polymimetic/playbook/roles/golang
#
...
#
# Usage:
# wget -qO - https://raw.githubusercontent.com/polymimetic/playbook/master/roles/golang/install.sh | bash
#
###########################################################################
...
readonly GIT_RAW="https://raw.githubusercontent.com/polymimetic/playbook/master/roles/golang"
...
install_golang() {
  ...
  local golang_files=${GIT_RAW}/files
