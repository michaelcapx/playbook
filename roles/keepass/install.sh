...
#
# Usage:
# wget -qO - https://raw.githubusercontent.com/michaelcapx/playbook/master/roles/keepass/install.sh | bash
#
###########################################################################
...
start_install() {
  e_title "Installing Keepass"

  e_success "Keepass installed"
}
