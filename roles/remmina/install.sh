...
#
# Usage:
# wget -qO - https://raw.githubusercontent.com/michaelcapx/playbook/master/roles/remmina/install.sh | bash
#
###########################################################################
...
start_install() {
  e_title "Installing Remmina"

  e_success "Remmina installed"
}
