...
#
# Usage:
# wget -qO - https://raw.githubusercontent.com/michaelcapx/playbook/master/roles/notepadqq/install.sh | bash
#
###########################################################################
...
start_install() {
  e_title "Installing Notepadqq"

  e_success "Notepadqq installed"
}
