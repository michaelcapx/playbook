...
###########################################################################
#
# WWW Bootstrap Installer
# https://github.com/polymimetic/playbook/roles/www
#
...
#
# Usage:
# wget -qO - https://raw.githubusercontent.com/polymimetic/playbook/master/roles/www/install.sh | bash
#
###########################################################################
...
readonly GIT_RAW="https://raw.githubusercontent.com/polymimetic/playbook/master/roles/www"
...
install_www() {
  e_title "Installing WWW"

  local www_files=${GIT_RAW}/files

  e_success "WWW installed"
}
