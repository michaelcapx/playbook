...
#
# Usage:
# wget -qO - https://raw.githubusercontent.com/michaelcapx/playbook/master/roles/security/install.sh | bash
#
###########################################################################
...
start_install() {
  e_title "Installing Security"

  e_success "Security installed"
}
