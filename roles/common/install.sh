...
###########################################################################
#
# Common Bootstrap Installer
# https://github.com/polymimetic/playbook/roles/common
#
...
#
# Usage:
# wget -qO - https://raw.githubusercontent.com/polymimetic/playbook/master/roles/common/install.sh | bash
#
###########################################################################
...
readonly GIT_RAW="https://raw.githubusercontent.com/polymimetic/playbook/master/roles/common"
...
install_common() {
  e_title "Installing Common packages"
  ...
  e_success "Common packages installed"
}
