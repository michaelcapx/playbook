...
# https://github.com/polymimetic/playbook/roles/admin
#
...
#
# Usage:
# wget -qO - https://raw.githubusercontent.com/polymimetic/playbook/master/roles/admin/install.sh | bash
#
###########################################################################
...
readonly GIT_RAW="https://raw.githubusercontent.com/polymimetic/playbook/master/roles/admin"
...
install_admin() {
  ...
  if [[ ${user_fullname} != "" ]]; then
    e_prompt "What is your full name?:"
    read user_fullname
  fi
