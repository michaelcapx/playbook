...
###########################################################################
#
# Vagrant Bootstrap Installer
# https://github.com/polymimetic/playbook/roles/vagrant
#
...
#
# Usage:
# wget -qO - https://raw.githubusercontent.com/polymimetic/playbook/master/roles/vagrant/install.sh | bash
#
###########################################################################
...
readonly GIT_RAW="https://raw.githubusercontent.com/polymimetic/playbook/master/roles/vagrant"
...
install_vagrant() {
  e_title "Installing Vagrant"

  local vagrant_files=${GIT_RAW}/files

  e_success "Vagrant installed"
}
