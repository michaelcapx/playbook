...
#
# Usage:
# wget -qO - https://raw.githubusercontent.com/michaelcapx/playbook/master/roles/dbeaver/install.sh | bash
#
###########################################################################
...
start_install() {
  e_title "Installing DBeaver"

  e_success "DBeaver installed"
}
