...
###########################################################################
#
# Mailcatcher Bootstrap Installer
# https://github.com/polymimetic/playbook/roles/mailcatcher
#
...
#
# Usage:
# wget -qO - https://raw.githubusercontent.com/polymimetic/playbook/master/roles/mailcatcher/install.sh | bash
#
###########################################################################
...
readonly GIT_RAW="https://raw.githubusercontent.com/polymimetic/playbook/master/roles/mailcatcher"
...
install_mailcatcher() {
  e_title "Installing Mailcatcher"

  local mailcatcher_files=${GIT_RAW}/files

  e_success "Mailcatcher installed"
}
