...
###########################################################################
#
# Projects Bootstrap Installer
# https://github.com/polymimetic/playbook/roles/projects
#
...
#
# Usage:
# wget -qO - https://raw.githubusercontent.com/polymimetic/playbook/master/roles/projects/install.sh | bash
#
###########################################################################
...
readonly GIT_RAW="https://raw.githubusercontent.com/polymimetic/playbook/master/roles/projects"
...
install_projects() {
  e_title "Installing Projects"

  local projects_files=${GIT_RAW}/files

  e_success "Projects installed"
}
