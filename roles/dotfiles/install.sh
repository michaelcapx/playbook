...
# https://github.com/polymimetic/playbook/roles/dotfiles
#
...
#
# Usage:
# wget -qO - https://raw.githubusercontent.com/polymimetic/playbook/master/roles/dotfiles/install.sh | bash
#
###########################################################################
...
readonly GIT_RAW="https://raw.githubusercontent.com/polymimetic/playbook/master/roles/dotfiles"
...
install_dotfiles() {
  ...
  local dotfiles_files=${GIT_RAW}/files
